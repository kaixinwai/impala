...
export const impalaPackage = new BuildPackage('impala');
...
impalaPackage.exportsSecondaryEntryPointsAtRoot = false;
...
impalaPackage.sourceDir = join(buildConfig.packagesDir, 'lib');
